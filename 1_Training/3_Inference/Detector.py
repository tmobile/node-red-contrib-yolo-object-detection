...
if __name__ == "__main__":
    ...
    input_image_paths = []
    input_video_paths = []
    # DBG print("input_paths:", input_paths)
    for item in input_paths:
        if item.lower().endswith(img_endings):
            input_image_paths.append(item)
        elif item.lower().endswith(vid_endings):
            input_video_paths.append(item)
    # DBG print("input_image_paths:", input_image_paths)
    # DBG print("input_video_paths:", input_video_paths)
                ...
                out_df = out_df.append(
                    pd.DataFrame(
                        [
                            ...
                            + single_prediction
                            + [input_labels[int(single_prediction[4])]] # label_name
                            + [x_size, y_size]
                        ],
                        columns=[
                            "image",
