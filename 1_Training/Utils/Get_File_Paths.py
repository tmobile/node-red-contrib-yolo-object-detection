    ...
    for entry in listOfFile:
        ...
        if os.path.isdir(fullPath):
            ...
            for ending in endings:
                if entry.lower().endswith(ending):
                    allFiles.append(fullPath)
    return allFiles


def ChangeToOtherMachine(filelist, repo="inventory", remote_machine=""):
    """
    ...
    '/home/ubuntu/inventory/Data/Street_View_Images/vulnerable/test.jpg'

    Get's converted to

    'C:/Users/Administrator/inventory/Data/Street_View_Images/vulnerable/test.jpg'
